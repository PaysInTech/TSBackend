...
class TechDataSourcePSQLContainer : PostgreSQLContainer<TechDataSourcePSQLContainer>("postgres")

class TestDataSource : PGSimpleDataSource() {

    @ClassRule
    private val sqlContainer = TechDataSourcePSQLContainer().also { it.start() }
