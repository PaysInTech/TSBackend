...
class TestDataSourcePSQLContainer : PostgreSQLContainer<TestDataSourcePSQLContainer>("postgres")

class TestDataSource : PGSimpleDataSource() {

    @ClassRule
    private val sqlContainer = TestDataSourcePSQLContainer().also { it.start() }
